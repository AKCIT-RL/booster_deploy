...
> **RESOLVIDO pelo release `7bb1462e`.** Os dois valores de tornozelo fecham também, como
> múltiplos exatos da armadura de **um** motor (`26.2e-6·36² = 0.0339552`): pitch
> `0.0679104 = 2,0×` (os dois motores somam) e roll `0.02037312 = 0,6×` (alavanca diferencial).
> O upstream confirma os dois fatores sozinho — escreve o amortecimento de tornozelo como
> `5.120323529816263/2` e `1.5360970589448788/0.6`, e dividi-los leva os dois tornozelos ao mesmo
> Kd de lado motor, `2,5601617649`. Derivação completa em
> [06](06-runbook-deploy-real.md#kd-de-junta-paralela-vs-kd-de-motor).
>
> Segue em aberto o teto de torque: `73,1/17,2 = 4,25` não bate com `2/0,6 = 3,33`, então isto
> ainda não explica o `17,2` do Ankle-Roll.
