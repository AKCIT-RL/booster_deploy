...
> **Nota de versão (release `7bb1462e`).** `--webots` e `--net` **não existem mais** em
> `scripts/deploy.py`, e o `ChannelFactory.Init` saiu de lá — a inicialização passou para dentro
> do `BoosterRobotPortal`, que agora fala ROS 2 em vez do binding Python do SDK. A flag nova é
> `--exit-mode` (`walking` | `damping`). Ver
> [11 §2c](11-reavaliacao-release-2026-09.md#2c-o-binding-python-do-sdk-deixou-de-existir).
